/**
 * A classe PrincipalContaBancaria possui um único método, que é o método main. Ela da exemplos de usos de instâncias da classe ContaBancariaSimplificada
...
public class PrincipalContaBancaria {//declaração da classe
	...
	public static void main(String[] argumentos) {
		...
		nomeCorrentista1 = nome.nextLine();
		System.out.println();
		System.out.print("Valor Depósito: ");
		Scanner saldo = new Scanner(System.in);
		saldoCorrentista1 = saldo.nextDouble();
		System.out.println();
		System.out.print("A conta é especial? (sim = true, não = false): ");
		Scanner especial = new Scanner(System.in);
		contaEspecial1 = especial.nextBoolean();
		...
		System.out.println("Forneça os dados para abertura da conta: ");
		System.out.print("Nome: ");
		nomeCorrentista2 = nome.nextLine();
		System.out.println();
		System.out.print("Valor Depósito: ");
		saldoCorrentista2 = saldo.nextDouble();
		System.out.println();
		System.out.print("A conta é especial? (sim = true, não = false): ");
		contaEspecial2 = especial.nextBoolean();
