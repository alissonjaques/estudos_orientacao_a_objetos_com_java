            ...
            if(simboloOperacao == '-'){ // se o usuário escolher subtrair
                ...
                if(simboloOperacao == '*'){ // se o usuário escolher multiplicar
                    ...
                    if(simboloOperacao == '/'){ // se o usuário escolher dividir
                        ...
                        if(numero2 == 0){ // se for divisão por zero

                            // informamos que não é possível dividir um número por zero
                            System.out.println("Operação inválida! Não é possível dividir um número por zero.     ");
