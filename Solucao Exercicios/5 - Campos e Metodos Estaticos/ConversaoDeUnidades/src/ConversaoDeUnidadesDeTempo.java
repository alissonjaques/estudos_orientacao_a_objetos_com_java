...
public class ConversaoDeUnidadesDeTempo{ // declaração da classe
	...
	*/
	...
	/**
		O método diasParaMinutos converte o valor passado em
		dias para minutos. Este método utiliza os métodos
		diasParaHoras e horasParaMinutos, pertencentes à 
		própria classe ConversaoDeUnidadesDeTempo, para realizar
		essa tarefa.
	...
	*/	
	public static double diasParaMinutos(double dias){
		...
		/*
		 * 	Passamos o argumento dias para o método diasParaHoras e
		 *  depois passamos esse método como argumento para o método
	...
	} // fim do método diasParaMinutos
	
	/**
		O método diasParaSegundos converte o valor passado em
		dias para segundos. Este método utiliza os métodos
		diasParaMinutos e minutosParaSegundos, pertencentes à 
		própria classe ConversaoDeUnidadesDeTempo, para realizar
		essa tarefa.
		@param dias o valor em dias
		@return o valor em segundos correspondente ao valor em 
	...
	public static double diasParaSegundos(double dias) {
		...
		/*
		 *	Passamos o argumento dias para o método diasParaMinutos
		 *	e depois passamos esse método como argumento para o método
	...
	} // fim do método diasParaSegundos
