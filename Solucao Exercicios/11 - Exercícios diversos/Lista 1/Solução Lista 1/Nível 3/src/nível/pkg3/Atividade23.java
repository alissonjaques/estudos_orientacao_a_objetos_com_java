...
/**
 * A classe Atividade23 representa uma calcularadora simples, ela possui um único método, que é o método main.
...
public class Atividade23{ // declara a classe
    ...
    /**
     * O método main permite a execução dessa classe, ele recebe como entrada dois números e uma opção (somar, subtrair
     * , multiplicar e dividir), como saída ele fornece o resultado da operação fundamental escolhida.
    ...
    public static void main(String[] argumentos){
        ...
        switch(opcao){// caso opcao seja:
            ...
            case 4: // 4, faça:
                    ...
                    if(numero2==0){ // se o denominador for 0
