...
public class Atividade62 { // declara a classe
    ...
    public static void main(String[] argumentos){
        ...
        */
        ...
        while(altura<=0){ // enquanto a altura for absurda
            System.out.print("Altura inválida. Por favor, insira uma altura válida: ");
            altura = scan.nextDouble();
        } // fim while
        System.out.print("Forneça a base do triângulo retângulo: ");
        base = scan.nextDouble();
        while(base<=0){ // enquanto a base for absurda
            System.out.print("Base inválida. Por favor, insira uma base válida: ");
            base = scan.nextDouble();
        } // fim while
