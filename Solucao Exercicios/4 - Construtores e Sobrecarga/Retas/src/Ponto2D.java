...
class Ponto2D { // declaração da classe 
	 ...
	 */
 	...
 	/**
 	 *  O métedo retornaCoordenadaY não possuí argumentos e retorna o valor correspondente à
 	 *  ordenada do ponto encapsulado.
 	 *  return y um valor flutuante que representa a ordenada y do ponto
 	 * 
 	 * */
 	public double retornaCoordenadaY() {
 		
 		return y;
 		
 	} // fim do método retornaCoordenadaY
 	
 	/**
 	 *  O métedo retornaCoordenadaX não possuí argumentos e retorna o valor correspondente à
 	 *  abscissa do ponto encapsulado.
 	 *  return x um valor flutuante que representa a abscissa x do ponto
 	 * 
 	 * */
 	public double retornaCoordenadaX() {
 		
 		return x;
 		
 	} // fim do método retornaCoordenadaX
