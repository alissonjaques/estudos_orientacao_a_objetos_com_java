...
public class PrincipalComplexo {//declaração da classe
	...
	public static void main(String[] argumentos) {
		...
		//solicitamos que o usuário digite as informações do segundo número complexo c+di
		...
		//criamos duas instâncias da classe Numero complexo que representaram dois números complexos
		NumeroComplexo numero1 = new NumeroComplexo();
		NumeroComplexo numero2 = new NumeroComplexo();
		
		//inicializamos os objetos com os dados fornecidos pelo usuário
		numero1.inicializaNumeroComplexo(realA,imaginarioB);
		numero2.inicializaNumeroComplexo(realC,imaginarioD);
