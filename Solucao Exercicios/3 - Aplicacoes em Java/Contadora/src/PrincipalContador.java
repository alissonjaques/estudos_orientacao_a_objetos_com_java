	...
	public static void main(String[] argumentos) {
		...
		switch(opcao){
			...
			case 1: //caso escolha zerar:
				...
				zera.zeraContador(); //chamamos o método que zera o conteúdo com a referência declarada
			...
			case 2: //caso escolha somar
				...
				Contador soma = new Contador();//criamos uma referência a uma instância da classe Contador
				...
				//inicializamos o objeto declarado neste bloco
				soma.inicializaContador(numero, interacoes);
