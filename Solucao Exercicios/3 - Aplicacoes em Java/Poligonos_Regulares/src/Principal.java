...
public class Principal {//declaração da classe
	...
	public static void main(String[] argumentos) {
		...
		//criamos duas referencias a instâncias da classe PoligoRegular
		PoligonoRegular umPoligono = new PoligonoRegular();
		PoligonoRegular pentagono = new PoligonoRegular();
		
		//inicializamos uma referência com os dados passados pelo usuário
		//e outra com dados passados diretamente nos argumentos
		umPoligono.inicializaPoligoRegular(ladosP,comprimentoLado);
		pentagono.inicializaPoligoRegular((byte)5,(double)4);
		
		//verificamos se o polígono passado pelo usuário é igual ao passado diretamente por nós
		...
		*/
		...
		//várias informações sobre os dois objetos são informadas na tela através de chamadas a seus métodos
