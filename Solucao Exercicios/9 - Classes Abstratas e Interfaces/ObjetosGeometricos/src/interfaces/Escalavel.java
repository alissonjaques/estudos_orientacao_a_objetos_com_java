...
/**
 * A interface Escalavel, que define que métodos um objeto que seja escalável
 * (isto é, que pode ter seu tamanho modificado como uma função do tamanho
 * anterior) deve conter. Esta interface não declara nenhum campo.
 */
